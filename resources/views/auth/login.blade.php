...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/logo-DesarrolloDelCampo.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/logo-DesarrolloDelCampo.png') }}">
