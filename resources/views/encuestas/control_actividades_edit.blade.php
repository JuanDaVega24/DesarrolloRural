<x-app-layout>
    ...
    <div class="py-4">
        <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div>
                        <h2 class="mb-1" style="color:#2d5f3f; font-weight:700;">
                            <i class="bi bi-pencil-square me-2"></i>Editar Control de Actividades
                        </h2>
                    ...
                    <a href="{{ route('control_actividades.show', $controlActividade->id) }}"
            ...
            <form method="POST" action="{{ route('control_actividades.update', $controlActividade->id) }}" class="bg-white shadow-lg rounded p-4 p-md-5">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-5 mt-2" id="cualesOtroDiv" style="display: none;">
                                        ...
                                        <input type="text" name="cuales_otro"
                                               class="form-control border-primary"
                                               value="{{ old('cuales_otro', $controlActividade->cuales_otro) }}"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-5 mt-2" id="otroProteccionDiv" style="display: none;">
                                        ...
                                        <input type="text" name="otro_proteccion"
                                               class="form-control border-primary"
                                               value="{{ old('otro_proteccion', $controlActividade->otro_proteccion) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit"
                                        ...
                                        <i class="bi bi-check-circle me-2"></i>Actualizar Control de Actividades
                                    </button>
