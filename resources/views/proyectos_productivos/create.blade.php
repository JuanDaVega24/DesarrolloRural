<x-app-layout>
    ...
    <div class="d-flex justify-content-center mt-4 mb-5">
        ...
        <div class="login-box" style="max-width:520px; width:100%;">
            ...
            <p class="login-subtitle">Registrar un nuevo proyecto productivo</p>
            ...
            <form action="{{ route('proyectos.store') }}" method="POST">
                ...
                <div class="mb-3 position-relative">
                    ...
                    <select name="metodo_creacion" class="form-control" required>
                        ...
                        <option value="manual" {{ old('metodo_creacion') == 'manual' ? 'selected' : '' }}>
                            Manual - Llenar formulario individual
                        </option>
                        <option value="excel" {{ old('metodo_creacion') == 'excel' ? 'selected' : '' }}>
