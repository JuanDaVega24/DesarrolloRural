        ...
        <div class="content-wrapper">
            ...
            <div class="page-header">
                <div class="header-content">
                    <h1>Gestión de Proyectos Productivos</h1>
                    <p>Administra y consulta los proyectos productivos registrados en el sistema</p>
                </div>
            ...
            {{-- === PANELS POR AÑO === --}}
            <div class="anos-grid">
                @forelse($anosConConteo as $anoData)
                    <a href="{{ route('proyectos.por-ano', $anoData->ano) }}" class="ano-panel">
                        <div class="panel-content">
                            <div class="ano-number">{{ $anoData->ano }}</div>
                            <div class="proyectos-count">
                                <i class="fas fa-seedling me-1"></i>
                                {{ $anoData->total_proyectos }} proyecto{{ $anoData->total_proyectos !== 1 ? 's' : '' }}
                            </div>
                        </div>
                ...
                @empty
                    <div class="no-anos-message">
                        <i class="fas fa-calendar-times fa-3x text-muted mb-3"></i>
                        <h4>No hay proyectos registrados</h4>
                        <p class="text-muted">Crea tu primer proyecto productivo para comenzar</p>
